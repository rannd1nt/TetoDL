...
from tetodl.core.domain.models import CliDownload, CliExit, CliMenu, DownloadSession
...
class TestApp:
    ...
    def test_app_launch_with_download(self, mock_cli, mocker):
        ...
        mock_exec = mocker.patch("tetodl.ui.cli.dispatch.execute_download")
