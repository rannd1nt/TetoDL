...
from ...core.domain.config import save_config, update_language
from ...core.dependency import get_ytdlp_version_info, verify_core_dependencies
from ...ui.tui.components import verification_header
from ...ui.tui.navigation import navigate_folders
...
def verify_dependencies(header_title=None):
    ...
    if not header_title:
        ...
        proposed_video = env.get('default_video_root')
        ...
        if use_default:
            ...
            start_nav_music = os.path.dirname(env.get('default_music_root'))
            ...
            if custom_music:
                ...
                cfg.music_root = env.get('default_music_root')
                clear()
                verification_header()
            ...
            start_nav_vid = os.path.dirname(env.get('default_video_root'))
            ...
            if custom_video:
                ...
                cfg.video_root = env.get('default_video_root')
                clear()
                verification_header()
