...
# ==== MODULE-LEVEL CONSTANTS (monkeypatch-able by tests) ====
CONFIG_PATH = env.get('config_path')
REGISTRY_PATH = env.get('registry_path')

# ==== MODULE-LEVEL CONFIG STATE ====
music_root: str = env.get('default_music_root')
video_root: str = env.get('default_video_root')
thumbnail_root: str = env.get('default_thumbnail_root')
...
def reset_to_defaults():
    ...
    music_root = env.get('default_music_root')
    video_root = env.get('default_video_root')
